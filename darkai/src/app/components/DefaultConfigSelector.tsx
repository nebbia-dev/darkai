...
export default function DefaultConfigSelector({teeth, color}) {
    ...
    return(
            <button className={`${activeDefault === teeth + color ? 'bg-gray-950 text-gray-50' : 'bg-gray-50 text-gray-950'} min-w-[200px] rounded-full py-1 pr-1 pl-4 flex items-center justify-between gap-4 h-[15%]`} onClick={setConfig}>
