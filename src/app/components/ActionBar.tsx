...
export default function ActionBar({ui} : {ui: boolean}) {
    ...
    return(
        <div className="relative z-30">
            <div
                className={`absolute flex items-center justify-center flex-col gap-4 ${ui ? 'bottom-5' : 'bottom-15'} left-[50%] translate-x-[-50%] w-2/4`}>
                ...
                <div className="bg-stone-200 px-4 py-2 rounded">Total: {total}€</div>
            </div>
        </div>
    )
}