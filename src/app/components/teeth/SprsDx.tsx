...
export default function SprsDx() {
    const toothGeometry = useTeethStore((state: State) => state.teethGeometry.sprsdx);
    const toothJewelType = useTeethStore((state: State) => state.teethJewelType.sprsdx);
    ...
    return <SPRSDX visible={toothVisibility} type={toothJewelType} mat={toothMaterial}/>
}