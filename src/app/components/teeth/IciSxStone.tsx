...
export default function IciSxStone() {
    ...
    const ICISXstone = memo(({visible, type} : {visible: boolean, type: string|undefined}): JSX.Element => {
    ...
    return <ICISXstone visible={toothStone.shape !== undefined} type={toothStone.shape}/>
}