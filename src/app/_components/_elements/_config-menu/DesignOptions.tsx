...
import FullIcon from "@/../public/design-icons/full.webp";
    ...
    return (
        <>
            <button ref={fullRef} type="button" value="full"
                    ...
                    <Image priority loading="eager" fetchPriority="high" src={FullIcon} alt="full-design"/>
            ...
            {!checkMolar(tooth) &&
                <>
                    <button ref={frameRef} type="button" value="frame"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image priority loading="eager" fetchPriority="high" src={Frame} alt="frame-design"/>
                    ...
                    <button ref={barRef} type="button" value="bar"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image priority loading="eager" fetchPriority="high" src={Spacer} alt="spacer-design"/>
            ...
            {(tooth === 'cidx' || tooth === 'cisx') &&
                <button ref={bigBarRef} type="button" value="bigBar"
                        ...
                        onClick={(e) => setDesign(e.currentTarget.value)}>
                    <Image priority loading="eager" fetchPriority="high" src={Bar} alt="bar-design"/>
            ...
            {!checkMolar(tooth) &&
                <>
                    <button ref={bezelRef} type="button" value="bezel"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image priority loading="eager" fetchPriority="high" src={Bezel} alt="bezel-design"/>
                    ...
                    <button ref={enamelRef} type="button" value="enamel"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image priority loading="eager" fetchPriority="high" src={Enamel} alt="enamel-design"/>
