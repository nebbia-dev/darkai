    ...
    return (
        <>
            <button ref={fullRef} type="button" value="full"
                    ...
                    <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/full.webp" alt="full-design"/>
            ...
            {!checkMolar(tooth) &&
                <>
                    <button ref={frameRef} type="button" value="frame"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/frame.webp" alt="frame-design"/>
                    ...
                    <button ref={barRef} type="button" value="bar"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/spacer.webp" alt="spacer-design"/>
            ...
            {(tooth === 'cidx' || tooth === 'cisx') &&
                <button ref={bigBarRef} type="button" value="bigBar"
                        ...
                        onClick={(e) => setDesign(e.currentTarget.value)}>
                    <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/bar.webp" alt="bar-design"/>
            ...
            {!checkMolar(tooth) &&
                <>
                    <button ref={bezelRef} type="button" value="bezel"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/bezel.webp" alt="bezel-design"/>
                    ...
                    <button ref={enamelRef} type="button" value="enamel"
                            ...
                            onClick={(e) => setDesign(e.currentTarget.value)}>
                        <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" src="/design-icons/enamel.webp" alt="enamel-design"/>
