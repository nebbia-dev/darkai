    ...
    return (
        <>
            <button disabled={signature} type="button" value="gold" onClick={(e) => setGold(e.currentTarget.value)}
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-24" src={Gold} alt="yellow-gold-bar"/>
            ...
            <button disabled={signature} type="button" value="rose" onClick={(e) => setGold(e.currentTarget.value)}
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-24" src={Rose} alt="rose-gold-bar"/>
            ...
            <button disabled={signature} type="button" value="white" onClick={(e) => setGold(e.currentTarget.value)}
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-24" src={White} alt="white-gold-bar"/>
            ...
            <button disabled={signature} type="button" value="black" onClick={(e) => setGold(e.currentTarget.value)}
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-24" src={Black} alt="black-gold-bar"/>
