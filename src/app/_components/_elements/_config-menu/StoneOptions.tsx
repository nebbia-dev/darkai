    ...
    return (
        <>
            <button ref={whDRef} type="button" disabled={!pave && !bezel} value="whD"
                ...
                <img className="pb-1 w-20" src="/color-icons/whD.webp" alt="white-diamond"/>
            ...
            <button ref={brDRef} type="button" disabled={!pave && !bezel} value="brD"
                ...
                <img className="pb-1 w-20" src="/color-icons/brD.webp" alt="brown-diamond"/>
            ...
            <button ref={blDRef} type="button" disabled={!pave && !bezel} value="blD"
                ...
                <img className="pb-1 w-20" src="/color-icons/blD.webp" alt="black-diamond"/>
            ...
            <button ref={rubyRef} type="button" disabled={!pave && !bezel} value="ruby"
                ...
                <img className="pb-1 w-20" src="/color-icons/ruby.webp" alt="ruby"/>
            ...
            <button ref={emeraldRef} type="button" disabled={!pave && !bezel} value="emerald"
                ...
                <img className="pb-1 w-20" src="/color-icons/emerald.webp" alt="emerald"/>
            ...
            <button ref={bSapphRef} type="button" disabled={!pave && !bezel} value="bSapph"
                ...
                <img className="pb-1 w-20" src="/color-icons/bSapph.webp" alt="blue-sapphire"/>
            ...
            <button ref={ySapphRef} type="button" disabled={!pave && !bezel} value="ySapph"
                ...
                <img className="pb-1 w-20" src="/color-icons/ySapph.webp" alt="yellow-sapphire"/>
            ...
            <button ref={pSapphRef} type="button" disabled={!pave && !bezel} value="pSapph"
                ...
                <img className="pb-1 w-20" src="/color-icons/pSapph.webp" alt="pink-sapphire"/>
            ...
            <button ref={aquaRef} type="button" disabled={!pave && !bezel} value="aqua"
                ...
                <img className="pb-1 w-20" src="/color-icons/aqua.webp" alt="aquamarina"/>
            ...
            {!bezel && jewelType?.includes('full') &&
                <>
                    <button ref={glitchRef} type="button" disabled={!pave} value="glitch"
                        ...
                        <img className="pb-1 w-20" src="/color-icons/glitch.webp" alt="glitch"/>
                    ...
                    <button ref={camoRef} type="button" disabled={!pave} value="camo"
                        ...
                        <img className="pb-1 w-20" src="/color-icons/camo.webp" alt="camo"/>
