    ...
    return (
        <>
            <button ref={whDRef} type="button" disabled={!pave && !bezel} value="whD"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={WHD} alt="white-diamond"/>
            ...
            <button ref={brDRef} type="button" disabled={!pave && !bezel} value="brD"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={BRD} alt="brown-diamond"/>
            ...
            <button ref={blDRef} type="button" disabled={!pave && !bezel} value="blD"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={BLD} alt="black-diamond"/>
            ...
            <button ref={rubyRef} type="button" disabled={!pave && !bezel} value="ruby"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Ruby} alt="ruby"/>
            ...
            <button ref={emeraldRef} type="button" disabled={!pave && !bezel} value="emerald"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Emerald} alt="emerald"/>
            ...
            <button ref={bSapphRef} type="button" disabled={!pave && !bezel} value="bSapph"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={BSapph} alt="blue-sapphire"/>
            ...
            <button ref={ySapphRef} type="button" disabled={!pave && !bezel} value="ySapph"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={YSapph} alt="yellow-sapphire"/>
            ...
            <button ref={pSapphRef} type="button" disabled={!pave && !bezel} value="pSapph"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={PSapph} alt="pink-sapphire"/>
            ...
            <button ref={aquaRef} type="button" disabled={!pave && !bezel} value="aqua"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Aqua} alt="aquamarina"/>
            ...
            <button ref={amethRef} type="button" disabled={!pave && !bezel} value="ameth"
                ...
                <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Ameth} alt="amethyst"/>
            ...
            {!bezel && jewelType?.includes('full') &&
                <>
                    <button ref={glitchRef} type="button" disabled={!pave} value="glitch"
                        ...
                        <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Glitch} alt="glitch"/>
                    ...
                    <button ref={camoRef} type="button" disabled={!pave} value="camo"
                        ...
                        <Image placeholder="blur" unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pb-1 w-20" src={Camo} alt="camo"/>
