    ...
    return (
        <>
            <button ref={whDRef} type="button" disabled={!pave && !bezel} value="whD"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={WHD} alt="white-diamond"/>
            ...
            <button ref={brDRef} type="button" disabled={!pave && !bezel} value="brD"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={BRD} alt="brown-diamond"/>
            ...
            <button ref={blDRef} type="button" disabled={!pave && !bezel} value="blD"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={BLD} alt="black-diamond"/>
            ...
            <button ref={rubyRef} type="button" disabled={!pave && !bezel} value="ruby"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Ruby} alt="ruby"/>
            ...
            <button ref={emeraldRef} type="button" disabled={!pave && !bezel} value="emerald"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Emerald} alt="emerald"/>
            ...
            <button ref={bSapphRef} type="button" disabled={!pave && !bezel} value="bSapph"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={BSapph} alt="blue-sapphire"/>
            ...
            <button ref={ySapphRef} type="button" disabled={!pave && !bezel} value="ySapph"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={YSapph} alt="yellow-sapphire"/>
            ...
            <button ref={pSapphRef} type="button" disabled={!pave && !bezel} value="pSapph"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={PSapph} alt="pink-sapphire"/>
            ...
            <button ref={aquaRef} type="button" disabled={!pave && !bezel} value="aqua"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Aqua} alt="aquamarina"/>
            ...
            <button ref={amethRef} type="button" disabled={!pave && !bezel} value="ameth"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Ameth} alt="amethyst"/>
            ...
            {!bezel && jewelType?.includes('full') &&
                <>
                    <button ref={glitchRef} type="button" disabled={!pave} value="glitch"
                        ...
                        <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Glitch} alt="glitch"/>
                    ...
                    <button ref={camoRef} type="button" disabled={!pave} value="camo"
                        ...
                        <Image unoptimized={true} loading="eager" fetchPriority="high" className="pb-1 w-20 transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)} src={Camo} alt="camo"/>
