    ...
    return (
        <>
            <button ref={polishedRef} disabled={isDisabled('nopave')} onClick={(e) => changePaveShape(e.currentTarget.value)}
                ...
                <img className="py-2 w-18" src="/finish-icons/polished.webp" alt="polished-metal"/>
            ...
            {!jewelType?.includes('enamel') &&
                ...
                <img className="py-2 w-18" src="/finish-icons/sandblasted.webp" alt="sandblasted-metal"/>
            ...
            {!jewelType?.includes('enamel') &&
                ...
                <img className="py-2 w-18" src="/finish-icons/diamondcut.webp" alt="diamond-cut-metal"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <img className="pt-2 pb-1 w-20" src="/finish-icons/mosaic.webp" alt="mosaic-pave"/>
            ...
            {(!jewelType || !jewelType.includes('enamel')) &&
                ...
                <img className="pt-2 pb-1 w-20" src="/finish-icons/round.webp" alt="round-pave"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <img className="pt-2 pb-1 w-20" src="/finish-icons/hexagon.webp" alt="hexagon-pave"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <img className="pt-2 pb-1 w-20" src="/finish-icons/princess.webp" alt="princess-pave"/>
            ...
            {(!jewelType || jewelType !== 'enamel') &&
                ...
                <img className="pt-2 pb-1 w-20" src="/finish-icons/baguette.webp" alt="baguette-pave"/>
