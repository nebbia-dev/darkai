        ...
        <>
            ...
            {!jewelType?.includes('enamel') &&
                <button ref={dCutRef} disabled={isDisabled('nopave')} onClick={(e) => changePaveShape(e.currentTarget.value)}
                     type="button"
                     value="nopave-dcut"
                     className={`${(finish === 'diamond_cut' && !pave?.shape) ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 ${!jewelType?.includes('enamel') ? 'mb-4' : ''} p-2 ${isDisabled('nopave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    unoptimized={true}
                    loading="eager"
                    fetchPriority="high"
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                <button ref={mosaicRef} disabled={isDisabled('pave')} onClick={(e) => changePaveShape(e.currentTarget.value)} type="button" value="mosaic"
                     className={`${pave?.shape === 'mosaic' ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 mb-4 ${isDisabled('pave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    onLoad={(e) => startOpacityTransition(e.target)}
            ...
            {(!jewelType || !jewelType.includes('enamel')) &&
                <button ref={roundRef} disabled={isDisabled('pave')} onClick={(e) => changePaveShape(e.currentTarget.value)} type="button" value="round"
                     className={`${pave?.shape === 'round' ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 mb-4 ${isDisabled('pave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    onLoad={(e) => startOpacityTransition(e.target)}
                    unoptimized={true} loading="eager" fetchPriority="high"
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                <button ref={hexRef} disabled={isDisabled('pave')} onClick={(e) => changePaveShape(e.currentTarget.value)} type="button" value="hexagon"
                     className={`${pave?.shape === 'hexagon' ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 mb-4 ${isDisabled('pave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    onLoad={(e) => startOpacityTransition(e.target)}
                    unoptimized={true} loading="eager" fetchPriority="high"
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                <button ref={princessRef} disabled={isDisabled('pave')} onClick={(e) => changePaveShape(e.currentTarget.value)} type="button" value="princess"
                     className={`${pave?.shape === 'princess' ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 mb-4 ${isDisabled('pave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    onLoad={(e) => startOpacityTransition(e.target)}
                    unoptimized={true} loading="eager" fetchPriority="high"
            ...
            {(!jewelType || jewelType !== 'enamel') &&
                <button ref={baguetteRef} disabled={isDisabled('pave')} onClick={(e) => changePaveShape(e.currentTarget.value)} type="button" value="baguette"
                     className={`${pave?.shape === 'baguette' ? 'lg:border-2 border-3' : 'lg:border-0 border-1' } w-[95%] h-[20vh] lg:h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 ${isDisabled('pave') ? 'text-slate-400' : 'text-slate-950 cursor-pointer'} flex flex-col items-center justify-center`}>
                <Image
                    onLoad={(e) => startOpacityTransition(e.target)}
                    unoptimized={true} loading="eager" fetchPriority="high"
