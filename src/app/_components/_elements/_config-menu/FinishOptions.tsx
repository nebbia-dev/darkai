    ...
    return (
        <>
            <button ref={polishedRef} disabled={isDisabled('nopave')} onClick={(e) => changePaveShape(e.currentTarget.value)}
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="py-2 w-18" src="/finish-icons/polished.webp" alt="polished-metal"/>
            ...
            {!jewelType?.includes('enamel') &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="py-2 w-18" src="/finish-icons/sandblasted.webp" alt="sandblasted-metal"/>
            ...
            {!jewelType?.includes('enamel') &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="py-2 w-18" src="/finish-icons/diamondcut.webp" alt="diamond-cut-metal"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-20" src="/finish-icons/mosaic.webp" alt="mosaic-pave"/>
            ...
            {(!jewelType || !jewelType.includes('enamel')) &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-20" src="/finish-icons/round.webp" alt="round-pave"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-20" src="/finish-icons/hexagon.webp" alt="hexagon-pave"/>
            ...
            {(!jewelType || (jewelType.includes('full') || jewelType.includes('bezel'))) &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-20" src="/finish-icons/princess.webp" alt="princess-pave"/>
            ...
            {(!jewelType || jewelType !== 'enamel') &&
                ...
                <Image unoptimized={true} priority width={150} height={150} loading="eager" fetchPriority="high" className="pt-2 pb-1 w-20" src="/finish-icons/baguette.webp" alt="baguette-pave"/>
