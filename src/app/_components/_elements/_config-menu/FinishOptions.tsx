...
export default function FinishOptions({tooth, jewelType, visible, signature}:{tooth:string|undefined, jewelType:string|undefined, visible: boolean|undefined, signature: boolean|undefined}) {
