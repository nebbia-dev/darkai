...
export default function PackagingSubOptions() {
    ...
    return (
        <>
            <div className={`${value === 'out' ? 'block' : 'invisible'} h-[20vh] lg:h-[120px] pt-4 mb-4 pl-6 text-center`}>
            ...
            <div
                className={`${value === 'in' ? 'block' : 'invisible'} relative top-[-15vh] h-[20vh] lg:h-[120px] mb-4 pl-6 text-center`}>
                <div className="w-[36px] flex flex-col gap-2 items-center bg-gray-50 rounded-full py-2 border-1">
                    <Tooltip title="White" placement="right">
            ...
            <div className={`${value === 'details' ? 'block' : 'invisible'} h-[20vh] lg:h-[120px] pt-4 mb-4 pl-6 text-center`}>
                <div className="w-[36px] flex flex-col gap-2 items-center bg-gray-50 rounded-full py-2 border-1">
            ...
            <div aria-hidden={true} className="lg:hidden block h-[20vh] lg:h-[120px] pt-4 mb-4 pl-6"></div>

            <div className={`${value === 'text' ? 'block' : 'invisible'} lg:static absolute right-[100%] bottom-[-20vh] z-100 w-[250px] h-[20vh] lg:h-[120px] pt-4 mb-4 pl-6 text-center lg:translate-y-[15%]`}>
