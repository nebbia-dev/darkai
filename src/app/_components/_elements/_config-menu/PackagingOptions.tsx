    ...
    return (
        <>
            <button type="button" value="out" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                    className={`cursor-pointer ${activeSubButton === 'out' ? 'border-2' : ''} w-[95%] h-[120px] mx-auto rounded-3xl bg-stone-200 mb-4 p-2 flex flex-col items-center justify-center`}>
            ...
            <button type="button" value="in" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                    className={`cursor-pointer ${activeSubButton === 'in' ? 'border-2' : ''} w-[95%] h-[120px] mx-auto rounded-3xl bg-stone-200 mb-4 p-2 flex flex-col items-center justify-center`}>
            ...
            <button type="button" value="details" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                    className={`cursor-pointer ${activeSubButton === 'details' ? 'border-2' : ''} w-[95%] h-[120px] mx-auto rounded-3xl bg-stone-200 mb-4 p-2 flex flex-col items-center justify-center`}>
            ...
            <button type="button" value="text" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                    className={`cursor-pointer ${activeSubButton === 'text' ? 'border-2' : ''} w-[95%] h-[120px] mx-auto rounded-3xl bg-stone-200 p-2 flex flex-col items-center justify-center`}>
