    ...
    return (
        <>
            <button type="button" value="out" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                ...
                <Image className="w-[80%] transition duration-250 opacity-0 object-cover" onLoad={(e) => startOpacityTransition(e.target)} unoptimized={true} loading="eager" fetchPriority="high" src={Out} alt="outside"/>
            ...
            <button type="button" value="in" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                ...
                <Image className="pb-1 w-[75%] transition duration-250 opacity-0 object-cover" onLoad={(e) => startOpacityTransition(e.target)} unoptimized={true} loading="eager" fetchPriority="high" src={In} alt="inside"/>
            ...
            <button type="button" value="details" onClick={(e) => setActiveSubButton(e.currentTarget.value)}
                ...
                <Image className="w-[80%] transition duration-250 opacity-0 object-cover" onLoad={(e) => startOpacityTransition(e.target)} unoptimized={true} loading="eager" fetchPriority="high" src={Details} alt="gold details"/>
