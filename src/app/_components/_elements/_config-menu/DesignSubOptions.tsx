...
export default function DesignSubOptions({tooth, type}: { tooth: string|undefined, type:string|undefined }) {
    ...
    return (
        <>
            <div aria-hidden={true} className="h-[20vh] lg:h-[120px] mb-4 pl-6">
            </div>
            <div aria-hidden={true} className="h-[20vh] lg:h-[120px] mb-4 pl-6">
            </div>
            <div aria-hidden={true} className="h-[20vh] lg:h-[120px] mb-4 pl-6">
            </div>
            {
                ...
                <div aria-hidden={true} className="h-[20vh] lg:h-[120px] mb-4 pl-6"></div>
            }
            <div className={`${value?.includes('bezel') || type?.includes('bezel') ? 'block' : 'invisible'} h-[20vh] lg:h-[120px] mb-4 pl-6 text-center`}>
            ...
            <div
                className={`${value === 'enamel' || type === 'enamel' ? 'block' : 'invisible'} h-[20vh] lg:h-[120px] mb-4 pl-6 text-center relative bottom-45 lg:bottom-60`}>
                <div className="w-[36px] flex flex-col gap-2 items-center bg-gray-50 rounded-full py-2 border-1">
