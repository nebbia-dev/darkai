...
export default function DesignSubOptions({tooth, type}: { tooth: string|undefined, type:string|undefined }) {
    const stoneShape = useTeethStore((state: State) => tooth ? state.teethStones[tooth].shape : undefined);
    const enamelColor = useTeethStore((state: State) => tooth ? state.teethEnamel[tooth] : undefined);
            ...
            <div
                ...
                <div className="w-[36px] flex flex-col gap-2 items-center bg-gray-50 rounded-full py-2 border-1">
                    <Tooltip title="Blue" placement="right">
                        <button type="button" value="blue" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#0073b6] ${enamelColor === 'blue' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Turquoise" placement="right">
                        <button type="button" value="turquoise" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#00bdca] ${enamelColor === 'turquoise' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Green" placement="right">
                        <button type="button" value="green" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#0c8241] ${enamelColor === 'green' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Yellow" placement="right">
                        <button type="button" value="yellow" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#ffc007] ${enamelColor === 'yellow' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Orange" placement="right">
                        <button type="button" value="orange" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#ff7b00] ${enamelColor === 'orange' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Red" placement="right">
                        <button type="button" value="red" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#e91825] ${enamelColor === 'red' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Pink" placement="right">
                        <button type="button" value="pink" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#ff6588] ${enamelColor === 'pink' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Purple" placement="right">
                        <button type="button" value="purple" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#ae3b9f] ${enamelColor === 'purple' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Ivory" placement="right">
                        <button type="button" value="ivory" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#f1eee1] ${enamelColor === 'ivory' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Brown" placement="right">
                        <button type="button" value="brown" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#4c3e34] ${enamelColor === 'brown' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                    <Tooltip title="Black" placement="right">
                        <button type="button" value="black" onClick={(e) => setEnamelColor(e.currentTarget.value)}
                                className={`w-[24px] h-[24px] bg-[#1d1e1e] ${enamelColor === 'black' ? 'border-2 border-sky-500' : 'border-1 border-black'} rounded-full cursor-pointer`}
                        ></button>
                    </Tooltip>
                </div>
            </div>
