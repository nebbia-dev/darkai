    ...
    return (
        <>
            <button ref={vampRef} type="button" value="vamp"
                    className={`${signature.vamp ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
            ...
            <button ref={sprinklesRef} type="button" value="sprinkles"
                    className={`${signature.sprinkles ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Sprinkles}
                     alt="sprinkles-logo"/>
            ...
            <button ref={bubblegumRef} type="button" value="bubblegum"
                    className={`${signature.bubblegum ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Bubblegum}
                     alt="bubblegum-logo"/>
            ...
            <button ref={bracesRef} type="button" value="braces"
                    className={`${signature.braces ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Braces}
                     alt="braces-logo"/>
            ...
            <button ref={tribalRef} type="button" value="tribal"
                    className={`${signature.tribal ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Tribal}
                     alt="tribals-logo"/>
            ...
            <button ref={crossRef} type="button" value="cross"
                    className={`${signature.cross ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Cross}
                     alt="cross-logo"/>
            ...
            <button ref={hammeredRef} type="button" value="hammered"
                    className={`${signature.hammered ? 'border-2 border-sky-400 rounded-4xl lg:rounded-25xl' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[20dvh] lg:h-[120px] mx-auto`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0" onLoad={(e) => startOpacityTransition(e.target)}
                     src={Hammered}
                     alt="hammered-logo"/>
