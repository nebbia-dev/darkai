    ...
    return (
        <>
            <button ref={vampRef} type="button" value="vamp"
                ...
                <Image unoptimized={true} loading="eager" fetchPriority="high" className="h-full transition duration-250 opacity-0 object-cover rounded-3xl" onLoad={(e) => startOpacityTransition(e.target)}
