    ...
    return (
        <>
            <button ref={vampRef} type="button" value="vamp"
                    className={`${signature.vamp ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
            ...
            <button ref={sprinklesRef} type="button" value="sprinkles"
                    className={`${signature.sprinkles ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
            ...
            <button ref={bubblegumRef} type="button" value="bubblegum"
                    className={`${signature.bubblegum ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
            ...
            <button ref={bracesRef} type="button" value="braces"
                    className={`${signature.braces ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
            ...
            <button ref={tribalRef} type="button" value="tribal"
                    className={`${signature.tribal ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
            ...
            <button ref={crossRef} type="button" value="cross"
                    className={`${signature.cross ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto mb-4`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
            ...
            <button ref={hammeredRef} type="button" value="hammered"
                    className={`${signature.hammered ? 'border-2 border-sky-400' : ''} cursor-pointer flex items-center justify-center w-[95%] h-[120px] mx-auto`}
                    onClick={(e) => setSignatureDesign(e.currentTarget.value)}>
                <img className="h-full"
