...
export default function TermsAndConditions({open, setClose}: {open: boolean, setClose: () => void}) {
    ...
    return (
        ...
        >
            <div
                className="absolute top-[50%] left-[50%] w-[92%] max-w-4xl translate-[-50%] overflow-hidden rounded-3xl border border-stone-200 bg-gray-50 shadow-[0_24px_80px_rgba(0,0,0,0.16)]">
                <div className="flex items-start justify-between gap-4 border-b border-stone-200 bg-gray-50/95 px-5 py-5 backdrop-blur-sm lg:px-8">
                    <div className="pr-2">
                        ...
                        <h1 id="terms-and-conditions-title" className="mt-2 text-2xl font-semibold text-stone-950 lg:text-3xl">
                            Terms and Conditions
                        </h1>
                        <p
                            id="terms-and-conditions-description"
                            className="mt-2 max-w-2xl text-sm leading-6 text-stone-600 lg:text-base"
                        >
                            Please review the terms that govern the use of the DARKAI website, checkout flow, and
                            products.
                        </p>
                    </div>
                    <button
                ...
                <article
                    className="max-h-[calc(84dvh-132px)] overflow-y-auto px-5 py-6 lg:px-8 lg:py-8 space-y-3 [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:tracking-[0.01em] [&_h2]:text-stone-950 [&_h3]:mt-6 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-stone-900 [&_p]:text-sm [&_p]:leading-7 [&_p]:text-stone-700 lg:[&_h2]:text-xl lg:[&_h3]:text-lg lg:[&_p]:text-[15px]">
                <p>This website is operated by DARKAI. Throughout the site, the terms “we”, “us” and “our” refer to
                DARKAI. DARKAI offers this website, including all information, tools and services available from this
                ...
                site. You may not use our products for any illegal or unauthorized purpose nor may you, in the use of
                ...
                encrypted during transfer over networks. You agree not to reproduce, duplicate, copy, sell, resell or
                exploit any portion of the Service, use of the Service, or access to the Service or any contact on the
                    website through which the service is provided, without express written permission by us.</p>
                ...
                used as the sole basis for making decisions without consulting primary, more accurate, more
                complete or more timely sources of information. Any reliance on the material on this site is at your
                own risk. This site may contain certain historical information. Historical information, necessarily, is
                not current and is provided for your reference only. We reserve the right to modify the contents of
                this site at any time, but we have no obligation to update any information on our site. You agree that
                ...
                <p>Dental jewelry products offered through the DARKAI configurator are aesthetic accessories intended
                solely for decorative purposes and are not classified as medical devices or medical treatments. All
                materials used in the creation of DARKAI dental jewelry, including precious metals such as gold, are
                industry-certified and commonly utilized within professional dental practices, and are considered
                    suitable for intraoral use when properly applied by a qualified dental professional.</p>
                <p>DARKAI works exclusively with approved materials and collaborates with licensed dental
                practitioners to ensure a high standard of safety and compatibility. However, as these products are
                    non-medical in nature, no medical claims are made regarding their use or effects.</p>
                <p>By purchasing and/or wearing dental jewelry, the customer acknowledges and agrees that any
                improper use, mishandling, lack of hygiene, unauthorized modification, or failure to follow
                professional aftercare instructions may result in damage or adverse effects, for which DARKAI and
                    any affiliated or partnered dental practitioners shall not be held liable.</p>
                <p>DARKAI and its partners expressly disclaim any responsibility for complications, injuries, or
                damages arising from misuse, neglect, alteration, or use outside of the intended purpose and
                    professional guidance provided.</p>
                <h3>SECTION 5.1 - CONTINUES</h3>
                <p>We have made every effort to display as accurately as possible the colours and images of our
                products that appear at the store. We cannot guarantee that your computer monitor's display of any
                color will be accurate. We reserve the right, but are not obligated, to limit the sales of our products or
                ...
                offer. All descriptions of products or product pricing are subject to change at any time without notice,
                at the sole discretion of us. We reserve the right to discontinue any product at any time. Any offer for
                any product or service made on this site is void where prohibited. We do not warrant that the quality
                ...
                and discretion and you should ensure that you are familiar with and approve of the terms on which
                ...
                these Terms of Service. You agree that your comments will not violate any right of any third-party,
                ...
                material, or contain any computer virus or other malware that could in any way affect the operation of
                the Service or any related website. You may not use a false e‑mail address, pretend to be someone
                other than yourself, or otherwise mislead us or third-parties as to the origin of any comments. You
                are solely responsible for any comments you make and their accuracy. We take no responsibility and
                ...
                your use of the Service or any related website for violating any of the prohibited uses.</p>
                ...
                non-infringement. In no case shall DARKAI, our directors, officers, employees, affiliates, agents,
                ...
                <p>You agree to indemnify, defend and hold harmless DARKAI and our parent, subsidiaries, affiliates,
                ...
                <p>These Terms of Service and any separate agreements whereby we provide you Services shall be
                    governed by and construed in accordance with the laws of Italy.</p>
                ...
                periodically for changes. Your continued use of or access to our website or the Service following the
                    posting of any changes to these Terms of Service constitutes acceptance of those changes.</p>
                        ...
                        <p>Questions about the Terms of Service should be sent to us at support@darkai-lab.com</p>
                    </article>
            </div>
        </Modal>
    )
