...
export default function IciDxStone() {
    ...
    const toothFinish = useTeethStore((state: State) => state.teethFinish.icidx);
    const ICIDXstone = memo(({visible, type, mat} : {visible: boolean, type: string|undefined, mat: string}): JSX.Element => {
    ...
    return <ICIDXstone visible={toothStone.shape !== undefined} type={toothStone.shape} mat={toothMaterial}/>
}