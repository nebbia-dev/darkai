...
export default function SpriSx() {
    const toothGeometry = useTeethStore((state: State) => state.teethGeometry.sprisx);
    const toothJewelType = useTeethStore((state: State) => state.teethJewelType.sprisx);
    ...
    return <SPRISX visible={toothVisibility} type={toothJewelType} mat={toothMaterial}/>
}