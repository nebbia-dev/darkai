            ...
            return (
                <>
                    ...
                    <mesh geometry={geometry[1]} visible={visible} position={position[1]}>
                        {material[0]}
                        {mat === 'pave' && <DecalPave position={[-1.46, 0, position[2].z]} pave='round' stone='whD'/>}
                        {mat === 'pave' && <DecalPave position={[2.46, 0, position[2].z]} pave='round' stone='whD'/>}
                    </mesh>
                    <mesh geometry={geometry[2]} visible={visible} position={position[2]}>
                        {material[1]}
                    </mesh>
                    <mesh geometry={geometry[3]} visible={visible} position={position[3]}>
                        {material[0]}
                    </mesh>
                </>
            )
