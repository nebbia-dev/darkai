...
export default function IlsDxStone() {
    ...
    const ILSDXstone = memo(({visible, type} : {visible: boolean, type: string|undefined}): JSX.Element => {
    ...
    return <ILSDXstone visible={toothStone.shape !== undefined} type={toothStone.shape}/>
}