...
export default function CsSxStone() {
    ...
    const toothFinish = useTeethStore((state: State) => state.teethFinish.cssx);
    const CSSXstone = memo(({visible, type, mat} : {visible: boolean, type: string|undefined, mat: string}): JSX.Element => {
    ...
    return <CSSXstone visible={toothStone.shape !== undefined} type={toothStone.shape} mat={toothMaterial}/>
}