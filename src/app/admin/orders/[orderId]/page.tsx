                                ...
                                <AccordionDetails sx={{
                                    ...
                                    <ul>
                                        {Object.entries(data?.[0].config.config.visible).map(tooth => {
                                            ...
                                            return <li key={`${tooth}Visibility`}>
                                                ...
                                                <div className="mb-2">
                                                    <p className="pl-2">Jewel
                                                        type: {firstCapital(data?.[0].config.config.type[tooth[0]].replace('Diamond', ''))} {data?.[0].config.config.type[tooth[0]].includes('Diamond') ? ' with ' + data?.[0].config.config.pave[tooth[0]] + 's' : ''}</p>
